...
public class BacklogController {
	...
	Iterable<ProjectTask> getProjectBacklog(@PathVariable String backlog_id, Principal principal){
	...
	public ResponseEntity<?> deleteProjectTask(@PathVariable String backlog_id, @PathVariable String pt_id, Principal principal){
		...
		return new ResponseEntity<String>("Project Task '"+ pt_id +"' was deleterd succesfully",HttpStatus.OK);
